...
def print_model_parm_flops(model_name, dataset_name, depth):
    ...
    model = models.__dict__[model_name](dataset=dataset_name, depth=depth)
    foo(model)
...
def show_summary(model_name, dataset_name, depth):
...
if __name__=='__main__':
    # import fire
    # fire. Fire()
    print_model_parm_flops(model_name='vgg', dataset_name='cifar10', depth=19) # 11.56G for resnet_152
    # show_summary(model_name='vgg', dataset_name='cifar10', depth=19) # 